...
if (_player != noone) {
    ...
    if (_current_cicle < 100 || (_current_cicle > 200 && _current_cicle < 300)) {
        _frame = 1;
    }
    ...
    var _max_bar_width = _player.max_life * _pixels_per_hp; 
    var _life_percent = clamp(_player.life / _player.max_life, 0, 1);
    ...
    var _segments = _player.max_life / 10;
    ...
    if (instance_exists(Object_player_ranged)) {
        ...
        for (var _i = 0; _i < _player.bullet_current; _i++) {
